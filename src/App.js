...
function App() {
  ...
  const aiURL = 'https://api.openai.com/v1/engines/text-curie-001/completions';
...
return (
  <>
    ...
    <div className="container">
      ...
      <h5>Insert a prompt to the AI and see what the computer has to tell to you</h5>
      <form method="POST" onSubmit={onSubmit} className="mb-3">
        ...
        <textarea className="form-control" id="PromptAi" rows="3" onChange={(e) => setUserPrompt(e.target.value)} placeholder="Name a famous actor from the early 1900's" value={userPrompt}></textarea>
        <br />
